...
return [	
    ...
    'FLASH_EMAIL_CONFIRM_REQUEST' => 'На указанный Вами при регистрации адрес электронной почты отправлено письмо для подтверждения. Зайдите в свой почтовый ящик, откройте письмо от сайта KuklaStadt и подтвердите ваш электронный адрес.',
