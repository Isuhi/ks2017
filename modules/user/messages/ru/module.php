...
return [	
    ...
    'SIGNUP_USERNAME' => 'Ваше имя',
    'SIGNUP_EMAIL' => 'Ваша электронная почта',
    'SIGNUP_PASSWORD' => 'Установите пароль',
    'SIGNUP_VERIFY_CODE' => 'Введите символы (клик по символам их меняет)',
    ...
    'PLEASE_FILL_FOR_PASSWORD_RESET_REQUEST' => 'Введите свой Email и мы пришлём вам инструкцию по восстановлению:',
    ...
    'FLASH_EMAIL_CONFIRM_REQUEST' => 'На указанный Вами при регистрации адрес электронной почты отправлено письмо для подтверждения. Зайдите в свой почтовый ящик, откройте письмо от сайта KuklaStadt и подтвердите ваш электронный адрес. Если письма долго нет, то проверьте папку со спамом - некоторые почтовые клиенты любят туда прятать такие письма.',
    'FLASH_EMAIL_CONFIRM_SUCCESS' => 'Спасибо! Ваш Email успешно подтверждён. Теперь Вы можете зайти на сайт со своми данными - логином и паролем.',
    ...
    'FOLLOW_TO_CONFIRM_EMAIL' => 'Для завершения регистрации пройдите по ссылке (или скопируйте ее и вставьте в адресную строку браузера):',
	
    'LINK_LIFETIME' => '(ссылка действует 24 часа). ',
