          ...
          <li class="menu-sidebar__item"><a href="#">Все статьи с мастер-классами</a></li>
			...
			<!-- <aside class="m-sidebar__menu">
				...
				<div class="block_reklami-left">
					<a href="http://suharikisdegtem.ru/"><img src="/img/banner_ssd_280x460_v2.jpg" width="280" alt="Магазин подарков 'Сухарики с Дегтем'"></a>
				</div>
			</aside> -->
			<aside class="m-sidebar__menu">
				<header class="m-sidebar__header">
			...
			<!-- <aside class="m-sidebar__menu">
								...
								<div class="block_reklami-left">
									<a href="http://suharikisdegtem.ru/"><img src="/img/banner_ssd_280x460_v4.jpg" width="280" alt="Магазин подарков 'Сухарики с Дегтем'"></a>
								</div>
							</aside> -->				
